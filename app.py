...
def set_variables(data_set, jsonl_file_path, corpus_json_path, tfidf_matrix_path, documents_path, keys_path, id, text_or_abstract):
    ...
    if data_set == 1:
        ...
        dff = pd.read_csv(r'C:\Users\User\.ir_datasets\cord19\2020-06-19\metadata.csv')
...
def set_dataset():
    ...
    if dataset == '1':
        ...
        documents_path = r'C:/Users/User/.ir_datasets/beir/webis-touche2020/webis-touche2020/documents.json'
        keys_path = r'C:/Users/User/.ir_datasets/beir/webis-touche2020/webis-touche2020/keys.json'
        tfidf_matrix_path = 'C:/Users/User/.ir_datasets/beir/webis-touche2020/webis-touche2020/tfidf_matrix.npz'
        id='_id'
        ...
        corpus_json_path = 'C:/Users/User/.ir_datasets/cord19/2020-06-19/files/corpus.jsonl'
        documents_path = r'C:/Users/User/.ir_datasets/cord19/2020-06-19/files/documents.json'
        keys_path = r'C:/Users/User/.ir_datasets/cord19/2020-06-19/files/keys.json'
        tfidf_matrix_path = 'C:/Users/User/.ir_datasets/cord19/2020-06-19/files/tfidf_matrix.npz'
        id='cord_uid'
