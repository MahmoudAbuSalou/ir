...
def readFileTopic(data_set):
    if data_set == 1:
        ...
        file_path = 'C:/Users/User/.ir_datasets/beir/webis-touche2020/webis-touche2020/topic_weights.csv'
    elif data_set == 2:
